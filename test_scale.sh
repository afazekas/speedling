...
./virtbs.sh cycle $slice controller:1,compute:${1:-1}
...
$ssh_cmd  PYTHONPATH=. python3 speedling/sl.py --config examples/inv_extend.py --config-option '{\"inventory\":\"speedling.ini\"}'  </dev/null
date
